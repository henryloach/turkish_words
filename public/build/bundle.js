...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img0, file$4, 1, 4, 14);
    			...
    			add_location(img1, file$4, 2, 4, 84);
    ...
    const file$2 = "src\\components\\TargetSentence.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			t = text(t_value);
    			add_location(span, file$2, 87, 8, 2581);
    		},
    		m: function mount(target, anchor) {
    ...
    // (75:4) {#if span.toLowerCase() === word.toLowerCase()}
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			input = element("input");
    			attr_dev(input, "class", "text-input svelte-1a9igrk");
    			...
    			add_location(input, file$2, 75, 8, 2225);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(75:4) {#if span.toLowerCase() === word.toLowerCase()}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(74:0) {#each spanList as span}",
    		ctx
    	});
    ...
    class TargetSentence extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { wordObj: 5 });
    ...
    const file$1 = "src\\components\\WordDetails.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			t2 = text(t2_value);
    			add_location(br, file$1, 25, 28, 832);
    			attr_dev(p, "class", "notes svelte-18e8zg1");
    			add_location(p, file$1, 25, 4, 808);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot(ctx) {
    	...
    	let if_block = /*wordObj*/ ctx[1].notes && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "correct-tick svelte-18e8zg1");
    			add_location(span, file$1, 18, 88, 491);
    			attr_dev(p0, "class", "target-sentence svelte-18e8zg1");
    			add_location(p0, file$1, 18, 4, 407);
    			attr_dev(p1, "class", "word-type svelte-18e8zg1");
    			add_location(p1, file$1, 20, 4, 609);
    			add_location(hr, file$1, 21, 4, 654);
    			attr_dev(p2, "class", "source-word svelte-18e8zg1");
    			add_location(p2, file$1, 22, 4, 664);
    			attr_dev(p3, "class", "source-sentence svelte-18e8zg1");
    			add_location(p3, file$1, 23, 4, 720);
    			attr_dev(button0, "class", "previous-button svelte-18e8zg1");
    			add_location(button0, file$1, 27, 4, 873);
    			attr_dev(button1, "class", "next-button svelte-18e8zg1");
    			add_location(button1, file$1, 28, 4, 993);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, activeId, wordObj*/ 35) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Header, WordDetails });
    	return [];
    }
