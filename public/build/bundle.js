...
var app = (function () {
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			t = text(t_value);
    			add_location(span, file$3, 95, 8, 2921);
    		},
    		m: function mount(target, anchor) {
    ...
    // (83:4) {#if span.toLowerCase() === word.toLowerCase()}
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$3, 83, 8, 2565);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(83:4) {#if span.toLowerCase() === word.toLowerCase()}",
    		ctx
    	});
    ...
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(82:0) {#each spanList as span}",
    		ctx
    	});
